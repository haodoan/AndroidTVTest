...
package com.jindo.LivetvVn.models;
...
public class Card {
    ...
    @SerializedName("CardType") private BrowseType mBrowseCardType;

    public void setBrowseCardType(BrowseType mBrowseCardType)
    {
        this.mBrowseCardType = mBrowseCardType;
    }
    public BrowseType getBrowseCardType()
    {
        return this.mBrowseCardType;
    }
